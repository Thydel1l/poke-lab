...
public class AuthUseCaseHelper {
     ...
     */
    public String validatePassword(LoginBody  request) throws AuthException, Exception {
     ...
     */
    public void validateUserStatus(LoginBody  request) throws AuthException, Exception {
